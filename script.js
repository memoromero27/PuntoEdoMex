...
// =========================================================================
// --- ANIMACIÓN DE INTRODUCCIÓN (AGUJERO EXPANSIVO) ---
// =========================================================================
// Usamos DOMContentLoaded para que inicie inmediatamente y no se trabe en Safari
document.addEventListener('DOMContentLoaded', () => {
    const introScreen = document.getElementById('intro-screen');

    if (introScreen) {
        // Le damos un respiro minúsculo de 50ms al navegador para que dibuje el círculo
        setTimeout(() => {
            // Al poner la clase "iniciar", el CSS arranca automáticamente 
            // su cronómetro interno de medio segundo (0.5s) que le configuramos.
            introScreen.classList.add('iniciar');
            
            // Destruimos el contenedor 1.5 segundos después para limpiar el código de la pantalla
            setTimeout(() => {
